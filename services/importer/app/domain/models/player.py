...
class Position(BaseModel):
    ...
    def defensiveline():
        return Position(
            position_id=13, offence_defence_or_special="D", abbreviation="DL", description="Defensive Lineman"
        )
    ...
    def offensiveline():
        return Position(
            position_id=5, offence_defence_or_special="O", abbreviation="OL", description="Offensive Lineman"
        )
    ...
    def defensivetackle():
        return Position(
            position_id=18, offence_defence_or_special="D", abbreviation="DT", description="Defensive Tackle"
        )
...
class Team(BaseModel):
    ...
    @staticmethod
    def free_agent():
        return Team(is_set=False)

    @staticmethod
    def bc(uniform: Optional[int] = None):
        return Team(team_id=1, abbreviation="BC", location="BC", nickname="Lions")

    @staticmethod
    def cgy(uniform: Optional[int] = None):
        return Team(team_id=2, abbreviation="CGY", location="Calgary", nickname="Stampeders", uniform=uniform)

    @staticmethod
    def edm(uniform: Optional[int] = None):
        return Team(team_id=3, abbreviation="EDM", location="Edmonton", nickname="Elks", uniform=uniform)

    @staticmethod
    def ham(uniform: Optional[int] = None):
        return Team(team_id=4, abbreviation="HAM", location="Hamilton", nickname="Tiger-Cats", uniform=uniform)
    ...
    @staticmethod
    def ott(uniform: Optional[int] = None):
        return Team(team_id=6, abbreviation="OTT", location="Ottawa", nickname="Redblacks", uniform=uniform)

    @staticmethod
    def ssk(uniform: Optional[int] = None):
        return Team(team_id=7, abbreviation="SSK", location="Saskatchewan", nickname="Roughriders", uniform=uniform)

    @staticmethod
    def tor(uniform: Optional[int] = None):
        return Team(team_id=8, abbreviation="TOR", location="Toronto", nickname="Argonauts", uniform=uniform)

    @staticmethod
    def wpg(uniform: Optional[int] = None):
        return Team(team_id=9, abbreviation="WPG", location="Winnipeg", nickname="Blue Bombers", uniform=uniform)
...
class Player(BaseModel):
    ...
    cfl_central_id: Optional[int] = None
    stats_inc_id: Optional[int] = None
    tsn_id: Optional[int] = None
    gracenote_id: Optional[str] = None
    status_current: Optional[int] = 1  # Active
