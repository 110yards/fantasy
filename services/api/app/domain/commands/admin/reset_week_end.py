...
def create_reset_week_end_command_executor(public_repo: PublicRepository = Depends(create_public_repository)):
...
class ResetWeekEndCommandExecutor(BaseCommandExecutor[ResetWeekEndCommand, ResetWeekEndResult]):
    def __init__(self, public_repo: PublicRepository):
