    ...
    sections = [
        {
            ...
            "actions": [
                ...
                {"id": "pass_net_yards", "description": "Yards (net)", "show_yards_per_point": True, },
...

        {
            "description": "Rushing",
            "actions": [
                {"id": "rush_net_yards", "description": "Yards (net)", "show_yards_per_point": True, },
...

        {
            ...
            "actions": [
                ...
                {"id": "receive_yards", "description": "Yards", "show_yards_per_point": True, },
...

        {
            ...
            "actions": [
                {"id": "kick_returns_yards", "description": "Yards", "show_yards_per_point": True, },
