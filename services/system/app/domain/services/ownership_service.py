...
class OwnershipService:
    ...
    def get_ownership(self) -> dict[str, OwnershipReportPlayer]:
        ...
        ownership_report_players: list[OwnershipReportPlayer] = []
        ...
        return {p.player_id: p for p in ownership_report_players}
