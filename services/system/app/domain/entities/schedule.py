...
class Matchup(BaseEntity):
    ...
    def type_display(self) -> str:
        return self.type.display() if self.type else ""
...
class ScheduleWeek(BaseModel):
    ...
    def week_id(self) -> str:
        return f"{self.week_number:02}" if self.week_number else ""

    @computed_field
    @property
    def heading(self) -> str:
        return ScheduleWeek.get_week_heading(self.week_type, self.week_number) if self.week_number else ""
