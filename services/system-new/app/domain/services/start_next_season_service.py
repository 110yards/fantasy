...
# from app.yards_py.domain.repositories.public_repository import (
#     PublicRepository, create_public_repository)
# from app.yards_py.domain.repositories.user_archive_league_repository import (
#     UserArchiveLeagueRepository, create_user_archive_league_repository)
# from app.yards_py.domain.repositories.user_league_repository import (
#     UserLeagueRepository, create_user_league_repository)
# from app.yards_py.domain.repositories.user_repository import (
...
#         StriveLogger.info("Start next season workflow started")

#         # update season / week (state)
#         StriveLogger.info("Fetching state")
...
#         # StriveLogger.info("Updating schedule")
...
#         # # update scoreboard
#         # StriveLogger.info("Updating scoreboard")
...
#         StriveLogger.info("Saving state")
...
#         StriveLogger.info("Archiving leagues")
...
#         StriveLogger.info("Erasing league previews")
