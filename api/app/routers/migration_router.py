...
from api.app.domain.migrations.issue_118_migration import Issue118Migration, create_issue_118_migration
from api.app.domain.migrations.issue_102_migration import Issue102Migration, create_issue_102_migration
from api.app.domain.migrations.issue_121_migration import Issue121Migration, create_issue_121_migration
from api.app.domain.migrations.issue_84_migration import Issue84Migration, create_issue_84_migration
from api.app.domain.migrations.issue_82_migration import Issue82Migration, create_issue_82_migration
from api.app.domain.migrations.issue_58_migration import Issue58Migration, create_issue_58_migration
from api.app.domain.migrations.league_command_sub_migration import LeagueCommandSubMigration, create_league_command_sub_migration
from typing import Optional
from api.app.domain.migrations.issue_46_migration import Issue46Migration, create_issue_46_migration
